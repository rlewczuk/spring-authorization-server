...
public final class JwtClientAssertionAuthenticationConverter implements AuthenticationConverter {
	...
	public Authentication convert(HttpServletRequest request) {
		...
		String issuer = (String) request.getAttribute(WebAttributes.ISSUER) + request.getRequestURI();

		return new OAuth2ClientAuthenticationToken(issuer, clientId, JWT_CLIENT_ASSERTION_AUTHENTICATION_METHOD, clientJwtAssertion, additionalParameters);
	}
}
